...
<div class="app-page-title">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(isset($role) ? route('app.roles.update', $role->id) : route('app.roles.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php if(isset($role)): ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($role->name ?? old('name')); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="name_bn" value="<?php echo e($role->name_bn ?? old('name_bn')); ?>" required autocomplete="name_bn" autofocus>
                                ...
                                <?php $__currentLoopData = $chunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $module->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <div class="mb-3 ml-4">
                                           ...
                                           <input type="checkbox" class="custom-control-input" id="permission-<?php echo e($permission->id); ?>" name="permissions[]" value="<?php echo e($permission->id); ?>" <?php if(isset($role)): ?>
                                           ...
                                           <?php endif; ?>>
                                           <label for="permission-<?php echo e($permission->id); ?>" class="custom-control-label"><?php echo e($permission->name); ?></label>
                                           </div>
                                       </div> 
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                    ...
                    <div class="col">
                        <section class="card">
                            <header class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?php echo e(route('app.roles.index')); ?>" class="btn-shadow mr-3 btn btn-warning pull-right" name="button">
         <i class="fas fa-arrow-left"></i>&nbsp;Back to list
        </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\advanchedqadmin\resources\views/backend/roles/form.blade.php ENDPATH**/ ?>